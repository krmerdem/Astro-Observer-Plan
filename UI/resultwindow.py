...
"}")
        ...
        self.sim_jh_radioButton.setFont(font)
        ...
        self.sim_hk_radioButton.setFont(font)
        ...
        self.sim_jk_radioButton.setFont(font)
...
"")
        ...
        QWidget.setTabOrder(self.wise_tableWidget, self.gaiaBtn)
        QWidget.setTabOrder(self.gaiaBtn, self.gaia_tableWidget)
        QWidget.setTabOrder(self.gaia_tableWidget, self.ztfBtn)
        QWidget.setTabOrder(self.ztfBtn, self.ztf_tableWidget)
        QWidget.setTabOrder(self.ztf_tableWidget, self.showallBtn)
        QWidget.setTabOrder(self.showallBtn, self.magh_checkBox)
        QWidget.setTabOrder(self.magh_checkBox, self.stype_checkBox)
        QWidget.setTabOrder(self.stype_checkBox, self.fov_lineEdit)
        QWidget.setTabOrder(self.fov_lineEdit, self.jh_checkBox)
        QWidget.setTabOrder(self.jh_checkBox, self.bv_checkBox)
        QWidget.setTabOrder(self.bv_checkBox, self.tableWidget)
        QWidget.setTabOrder(self.tableWidget, self.magj_checkBox)
        QWidget.setTabOrder(self.magj_checkBox, self.magv_checkBox)
        QWidget.setTabOrder(self.magv_checkBox, self.index_lineEdit)
        QWidget.setTabOrder(self.index_lineEdit, self.bv_radioButton)
        QWidget.setTabOrder(self.bv_radioButton, self.jh_radioButton)
        QWidget.setTabOrder(self.jh_radioButton, self.ra_checkBox)
        QWidget.setTabOrder(self.ra_checkBox, self.range_lineEdit)
        QWidget.setTabOrder(self.range_lineEdit, self.showBtn)
        QWidget.setTabOrder(self.showBtn, self.dec_checkBox)
        QWidget.setTabOrder(self.dec_checkBox, self.otype_checkBox)
        QWidget.setTabOrder(self.otype_checkBox, self.magb_checkBox)
